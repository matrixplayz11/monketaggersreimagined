...
class GameInfo:
    def __init__(self):
        self.TitleId : str = "1DF792"
        self.SecretKey : str = "PUMNU67MYT554M86XT8RMKNMGW6AUW9ORC355KN3C4DQSXA3FD
"
        self.ApiKey : str = "OC|9536570466388973|429464eb11d3ef18a23ff06eb9d11741
"
